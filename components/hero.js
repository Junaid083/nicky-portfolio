...
import nickyImg from "../public/images/nicky.png";
      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <span className="text-4xl font-bold leading-snug tracking-tight text-yellow-500 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-yellow-500">
              <TypeAnimation
                sequence={[
                  "I'm", //  Continuing previous Text
                  100,
                  "I'm Monica",
                  200,
                  "I'm",
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              I am a dynamic and strategic basketball coach with a primary focus
              on optimizing team performance through a specialized approach. On
              the defensive end, my coaching philosophy emphasizes a tenacious
              and disciplined style, instilling in players the importance of
              effective defense as a cornerstone of success.
            </p>
          </div>
      ...
      {/* <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Trusted by <span className="text-yellow-600">2000+</span> customers
            worldwide
          </div>
